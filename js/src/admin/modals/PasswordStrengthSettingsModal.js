...
export default class PasswordStrengthSettingsModal extends SettingsModal {
	...
	form() {
		return [
			m('.Form-group', [
				m('label.psHeading', app.translator.trans(localePrefix + 'colorOptions')),
			...
			m('.Form-group', [
				m('label.psHeading', app.translator.trans(localePrefix + 'otherOptions')),
			]),
			m('.Form-group', [
				m(
					'label',
					Switch.component({
						state: this.setting(settingsPrefix + 'enableInputColor', '0')() === '1',
						children: app.translator.trans(localePrefix + 'enableInputColor'),
						onchange: (value) => {
							this.setting(settingsPrefix + 'enableInputColor')(value ? '1' : '0');
						},
					})
				),
			]),
			m('.Form-group', [
				m(
					...
					Switch.component({
						state:
							this.setting(settingsPrefix + 'enableInputBorderColor', '1')() === '1',
						children: app.translator.trans(localePrefix + 'enableInputBorderColor'),
						onchange: (value) => {
			...
			m('.Form-group', [
				m(
					'label',
					Switch.component({
						state: this.setting(settingsPrefix + 'enablePasswordToggle', '1')() === '1',
						children: app.translator.trans(localePrefix + 'enablePasswordToggle'),
						onchange: (value) => {
